...
typedef boost::function<void (int64_t)> BenchmarkTest;
typedef boost::function<void (int64_t, const std::string&)> CommandLineBenchmarkTest;
...
#define BENCHMARK_ARG(name, arg) \
	void BENCHMARK_ARG_##name(int64_t benchmark_iterations, arg)
...
#define BENCHMARK(name) \
	void BENCHMARK_##name(int64_t benchmark_iterations); \
...
#define BENCHMARK_ARG_CALL(name, id, arg) \
	void BENCHMARK_ARG_CALL_##name_##id(int64_t benchmark_iterations) { \
...
#define BENCHMARK_ARG_CALL_COMMAND_LINE(name) \
	void BENCHMARK_ARG_CALL_##name(int64_t benchmark_iterations, const std::string& arg) { \
		BENCHMARK_ARG_##name(benchmark_iterations, arg); \
	} \
